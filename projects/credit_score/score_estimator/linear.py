...
model2=linear_model.LinearRegression().fit(train_x_poly,train_y)
pred2=model2.predict(test_x_poly)


model3=linear_model.Linear_Regression

###############################################################################
print("Mean squared error:",mean_squared_error(test_y, pred))
print('R squared: %.2f' % r2_score(test_y, pred))

print("Mean squared error:",mean_squared_error(test_y, pred2))
print('R squared: %.2f' % r2_score(test_y, pred2))
